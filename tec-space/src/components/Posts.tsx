              ...
              >
                <div className="relative">
                  <img
                    className="w-full"
                    src={post.imagemUrl}
                    alt="Imagem post criado"
                  />
                  <div className="hover:bg-transparent transition duration-300 absolute bottom-0 top-0 right-0 left-0 bg-gray-900 opacity-25"></div>
                  <div className="absolute bottom-0 left-0 bg-orange-500 px-2 py-1 rounded-e-md text-white hover:bg-white hover:text-purple-600 transition duration-500 ease-in-out">
